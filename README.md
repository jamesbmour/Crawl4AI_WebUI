...
```bash
bash ./run.sh setup   # venv + crawl4ai + Playwright browsers + npm install
...
```bash
bash ./run.sh prod    # http://127.0.0.1:8742
```
...
```bash
bash ./run.sh test    # mapping-layer unit tests + API smoke tests
```
