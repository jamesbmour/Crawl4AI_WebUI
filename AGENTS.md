...
**Working name / inferred goal:** A web UI for the [Crawl4AI](https://github.com/unclecode/crawl4ai) library — a browser to issue, monitor, and review web crawl jobs produced by Crawl4AI. The exact scope (single-page demo vs. multi-user dashboard, local-only vs. hosted, etc.) is **unconfirmed** and must be agreed before code is written.
